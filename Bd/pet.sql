...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-06-2023 a las 00:41:32
...
('ffu19cqqo0krx6f4web8lfvxy37da5ey', '.eJxVjEEOwiAQRe_C2pDMAB3q0r1nIDNApWpoUtpV491tky50-997f1OB16WEteU5jEldlfXq8jsKx1euB0lPro9Jx6ku8yj6UPRJm75PKb9vp_t3ULiVvTaCTgx1zjN1AuxIDCNFlCg9WedTtuDREMLg8wAZMJKAd72F3ST1-QL36jd5:1qBjiS:EPPWK3-_JUKpxze8XMCyJ2gI8znjz6XvOr5mebOJtlQ', '2023-07-04 22:20:48.833747'),
...
CREATE TABLE `tbl_dueno` (
  ...
  `codigo_qr_nombre_archivo` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `tbl_caracteristicas`
  MODIFY `Id_Caracteristicas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT de la tabla `tbl_dueno`
--
ALTER TABLE `tbl_dueno`
  MODIFY `Id_Dueno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT de la tabla `tbl_envio`
--
ALTER TABLE `tbl_envio`
  MODIFY `Id_Envio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `tbl_mascota`
--
ALTER TABLE `tbl_mascota`
  MODIFY `Id_Mascota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;
