...
from Pet.views import ListadoMascota,EliminarMascota,MostrarActualizarMascota,ActualizarMascota,PaginadoMascota
...
urlpatterns = [
    ...
    #Paginar Mascotas
    path('MisMascotas/Paginar',PaginadoMascota)
]
